...
Folder.create!([
  ...
  {name: "for later", resource_thread_id: 2},
  {name: "Downloadable online", resource_thread_id: 4},
  {name: "Available at UP Libraries ", resource_thread_id: 4}
])
Keyword.create!([
...
Rfile.create!([
  ...
  {resource_id: 3, folder_id: 3},
  {resource_id: 5, folder_id: 4},
  {resource_id: 6, folder_id: 4},
  {resource_id: 7, folder_id: 4},
...
Tag.create!([
  ...
  {resource_thread_id: 2, keyword_id: 2},
  {resource_thread_id: 3, keyword_id: 3},
  {resource_thread_id: 4, keyword_id: 4},
  {resource_thread_id: 4, keyword_id: 5},
...
Vote.create!([
  ...
  {value: "up", user_id: 3, resource_id: 1}
])
